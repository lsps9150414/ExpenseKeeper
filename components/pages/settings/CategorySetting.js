...
export default class CategorySetting extends Component {
  ...
  render() {
    // console.log('category settings', this.props);
    // console.log('rendering category setting');
    // console.log('categoriesData', this.props.categoriesData);
    // console.log('categoriesOrder', this.props.categoriesOrder);
    return (
      <SortableListView
        containerStyle={{
    ...
    // onRowMove={
    //   (args) => {
    //     myOrder.splice( args.toOrder, 0, myOrder.splice(args.fromOrder, 1)[0] );
    //     this.forceUpdate();
    //   }
    // }
  }
